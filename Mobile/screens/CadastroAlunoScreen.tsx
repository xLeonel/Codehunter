...
export default function CadastroAluno({
    ...
    const Cadastrar = async () => {
        ...
        try {
            ...
            const url = "http://192.168.0.6:8000/api/Usuario/"
            ...
            if (response === 'Cadastrado') {
                ...
                try {
                    const url = "http://192.168.0.6:8000/api/Login/Usuario"
                    const request = await fetch(url, {
                        method: "post",
                        headers: {
                            'Content-Type': 'application/json'
                    ...
                    if (response === 'Conta não existe') {
                        ...
                        if (response !== undefined) {
                            ...
                            try {
                                const url = "http://192.168.0.6:8000/api/Usuario/VagasMatch"
                                const request = await fetch(url, {
                                    method: "get",
                                    headers: {
    ...
    const verificarEmail = async () => {
        ...
        try {
            setLoading(true);
            const request = await fetch('http://192.168.0.6:8000/api/Usuario/IsAluno', {
                body: JSON.stringify(body),
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
